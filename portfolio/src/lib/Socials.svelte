<div class="container h-full mx-14 flex justify-center items-center text-center flex-col">
    <div>
        <p>
            ...
            If you wish to get in contact with me, you can reach me via my socials. </p>
    </div>
    <div class="mt-10 flex">
        <!-- mail icon -->
        <a href="mailto:edizturan1@gmail.com" class="social">
            <svg width="40px" height="40px" viewBox="0 -2.5 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- instagram icon -->
        <a href="https://www.instagram.com/ediz_turan" target="_blank" class="social">
        ...
        <!-- github icon -->
        <a href="https://www.github.com/ediz97" target="_blank" class="social">
